...
async function connectToWA() {
  ...
  console.log("Connecting ❤️KingKavi-MD❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️KingKavi-MD❤️ installed successful ✅");
      console.log("❤️KingKavi-MD❤️ connected to whatsapp ✅");

      let up = `❤️KingKavi-MD❤️ connected successful ✅`;
      let up1 = `Hello Kavi, I made bot successful`;

      robin.sendMessage(ownerNumber + "@s.whatsapp.net", {
        image: {
          url: `https://i.imghippo.com/files/SsK8429jRI.jpg`,
        },
        caption: up,
      });
      robin.sendMessage("94770051298@s.whatsapp.net", {
        image: {
          url: `https://i.imghippo.com/files/eSz8878HSc.jpg`,
        },
        caption: up1,
      });
    }
...
app.get("/", (req, res) => {
  res.send("hey, ❤️KingKavi-MD❤️ Successfuly Started✅");
});
app.listen(port, () =>
